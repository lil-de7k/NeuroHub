    ...
    <div className='flex py-2 px-4 sm:px-6 md:px-10 justify-between items-center bg-black w-full shadow-sm fixed z-50'>
      ...
      {isMenuOpen && (
        <div className='md:hidden absolute top-full left-0 right-0 bg-black border-t border-gray-800 p-4 flex flex-col gap-2'>
          <a href='https://github.com' target='_blank' rel='noopener noreferrer' className='text-white text-[13px] flex items-center gap-3 py-2'>
            <FontAwesomeIcon icon={faGithub} className='text-[15px]' />
            <span>GitHub</span>
          </a>
          <a href='https://linkedin.com' target='_blank' rel='noopener noreferrer' className='text-white text-[13px] flex items-center gap-3 py-2'>
            <FontAwesomeIcon icon={faLinkedin} className='text-[14px]' />
            <span>LinkedIn</span>
          </a>
          <a href='https://wa.me/2012254567890' target='_blank' rel='noopener noreferrer' className='text-white text-[13px] flex items-center gap-3 py-2'>
            <FontAwesomeIcon icon={faWhatsapp} className='text-[15px]' />
            <span>WhatsApp</span>
          </a>
          <a href='https://instagram.com' target='_blank' rel='noopener noreferrer' className='text-white text-[13px] flex items-center gap-3 py-2'>
